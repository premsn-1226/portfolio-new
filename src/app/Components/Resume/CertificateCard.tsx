...
export default function CertificateCard(props: any) {
  return (
    <div className="w-full h-1/3 group flex">
      ...
      <div className="w-full h-auto bg-black bg-opacity-20 hover:bg-opacity-30 duration-300 rounded-lg p-10 lgl:px-10 flex flex-col justify-center shadow-shadowOne">
